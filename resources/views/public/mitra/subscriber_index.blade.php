                ...
                <div class="col-md-8 col-sm-12 p-sm-1 p-md-5">
                    <div class="card-body p-0">
                        ...
                        <form action="{{ route('subscriber.mitra.store') }}" method="post">
                            ...
                            <button type="submit" class="btn btn-success rounded-0 float-right">Subscribe</button>
                            <p class="card-text"><small class="text-muted">Telah memiliki akun Mitra? <a href="#">Login
                                        di sini</a></small></p>
                    </div>
                </div>
            </div>
