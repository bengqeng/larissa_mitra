      ...
      <div class="content-wrap pt-3 pb-0">
        ...
        <div class="overflow-hidden parallax d-flex align-items-center" data-bottom-top="background-position:0px 200px;"
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6">
                <h2 class="text-white">"Menjadi klinik estetika natural terbaik dengan memiliki jaringan terbesar untuk merawat jutaan
          ...
          <div class="row justify-content-between">
            <div class="col-sm-3">
              ...
              <p class="text-white">Nikmati pelayanan professional kami di gerai yang tersebar di Pulau
                Jawa dan
                Bali</p>
              <a href="https://www.facebook.com/larissacenter/" class="social-icon si-small text-white border-0 si-facebook"
                title="Facebook">
              ...
              <a href="https://instagram.com/larissacenter/" class="social-icon si-small text-white border-0 si-instagram"
                title="instagram">
